...
export function Logo({
	...
	return (
		<span
			className={cn(
				"flex items-center gap-2.5 font-semibold text-foreground leading-none",
				className,
			)}
		>
			<svg
			...
			{withLabel && (
				<span className="hidden text-base tracking-tight md:block">
					Roam Loom
				</span>
			)}
		</span>
